...
public class ConsoleColors {
    ...
    // Reset
    public static final String RESET = "\u001B[0m";  // Resets all styles
    ...
    public static final String BLACK_BOLD_BRIGHT = "\u001B[90;1m";
    public static final String RED_BOLD_BRIGHT = "\u001B[91;1m";
    public static final String GREEN_BOLD_BRIGHT = "\u001B[92;1m";
    public static final String YELLOW_BOLD_BRIGHT = "\u001B[93;1m";
    public static final String BLUE_BOLD_BRIGHT = "\u001B[94;1m";
    public static final String PURPLE_BOLD_BRIGHT = "\u001B[95;1m";
    public static final String CYAN_BOLD_BRIGHT = "\u001B[96;1m";
    public static final String WHITE_BOLD_BRIGHT = "\u001B[97;1m";
